																					...
																					<tbody>
																						<tr>
																							...
																							<th class="t_left icon02">
																								Factor Value
																								<button type="button" class="btn btn-sm btn-sky btn_right">Add Value</button>
																							</th>
																						...
																						<tr>
																							...
																							<td class="t_left pd_t20 pd_r20 pd_b20 pd_l20 v_top" rowspan="3" id="factorValData">
																							<!-- 
																							...
																							<td class="t_left pd_t20 pd_r20 pd_b20 pd_l20 v_top" rowspan="3" id="ruleAttrData"></td>
																						</tr>
																						<tr>
